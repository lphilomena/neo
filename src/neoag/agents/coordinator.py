...
SKILL_TO_MODULE = {
    "neoag-input-qc": "neoag.agent_skills.input_qc",
    "neoag-tool-and-reference-qc": "neoag.agent_skills.tool_reference_qc",
    "neoag-run-demo-and-smoke": "neoag.agent_skills.run_demo_smoke",
    "neoag-evidence-scoring": "neoag.agent_skills.evidence_scoring",
    "neoag-hla-loh-appm-review": "neoag.agent_skills.appm_review",
    "neoag-ccf-clonality-review": "neoag.agent_skills.ccf_review",
    "neoag-ranking-compare": "neoag.agent_skills.ranking_compare",
    "neoag-patient-report": "neoag.agent_skills.patient_report",
    "neoag-sliding-run": "neoag.agent_skills.sliding_run",
    "neoag-result-inspector": "neoag.agent_skills.result_inspector",
    "neoag-purity-cnv-run-and-review": "neoag.agent_skills.purity_cnv_review",
    "neoag-hla-typing-run-and-compare": "neoag.agent_skills.hla_typing_compare",
    "neoag-fusion-rna-run": "neoag.agent_skills.fusion_rna_run",
    "neoag-rna-fastq-to-tpm": "neoag.agent_skills.rna_fastq_to_tpm",
}

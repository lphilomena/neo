...
EVENT_FIELDS = [
    ...
    "splice_alignment_qc_status","matched_normal_junction_status","matched_normal_junction_reads",
    "normal_cohort_junction_status","annotated_normal_isoform_status",
...
PEPTIDE_FIELDS = [
    ...
    "cancer_driver_context","oncokb_annotated","cosmic_cgc_flag",
    "cancer_gene_source_count","cancer_gene_sources","cancer_gene_match_basis","cancer_gene_context",
    "crosses_junction","contains_novel_aa","junction_position_in_peptide_1based",

    ...
    for row_no, row in enumerate(read_delimited(p), start=2):
        ...
        if protein:
            ...
            result["peptide_origins"].append({
                ...
                "junction_ids": join_tokens(jchain), "required_junction_ids": join_tokens(jchain),
                "junction_offset_in_peptide": ";".join(boundaries),
    ...
    *,
    ...
    for row_no, row in enumerate(read_delimited(p), start=2):
        ...
        result["peptide_origins"].append({
            ...
            "required_junction_ids": sth.get("junction_chain", ""),

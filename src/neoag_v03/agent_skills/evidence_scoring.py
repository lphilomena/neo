...
def main(argv: list[str] | None = None) -> int:
    ...
    out_events = score_dir / "ranked_events.v03.tsv"
    out_peptides = score_dir / "ranked_peptides.v03.tsv"
    cmd = ["neoag-v03", "score-v03", "--raw-events", args.raw_events, "--raw-peptides", args.raw_peptides, "--presentation", args.presentation, "--out-events", str(out_events), "--out-peptides", str(out_peptides)]
    optional = {

...
def run_sv_v03_score(
    *,
    ...
    """NetMHCpan/MHCflurry → presentation → APPM/CCF → score_v03 → report."""
    outdir = Path(outdir)
    ...
    shutil.copy2(raw_events, events_path)
    shutil.copy2(raw_peptides, peptides_path)
    ...
    ranked_events = scoring / "ranked_events.v03.tsv"
    ranked_peptides = scoring / "ranked_peptides.v03.tsv"
    evs, peps = score_v03(
        events_path,
        peptides_path,
        pres_path,
    ...
    val_rows = make_validation_plan_v03(peps, outdir=outdir)
    val_path = scoring / "validation_plan.v03.tsv"
    ...
    prov = outdir / "provenance.sv_score_v03.json"

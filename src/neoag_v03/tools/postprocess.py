...
from ..adapters.ascat import (
    parse_ascat_purity,
    parse_ascat_segments,
    write_purity_evidence as write_ascat_purity_evidence,
    write_cnv_segments as write_ascat_cnv_segments,
)
...
def ascat_to_purity_tsv(summary_path: str | Path, sample_id: str, out_path: str | Path) -> None:
    write_ascat_purity_evidence(out_path, parse_ascat_purity(summary_path, sample_id))


def ascat_to_cnv_tsv(segments_path: str | Path, out_path: str | Path) -> None:
    write_ascat_cnv_segments(out_path, parse_ascat_segments(segments_path))

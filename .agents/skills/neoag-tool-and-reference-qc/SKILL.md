---
name: neoag-tool-and-reference-qc
description: Check external bioinformatics tools and reference resources for Project B.
---
...
```bash
python -m neoag_v03.agent_skills.tool_reference_qc --project-root <PROJECT_ROOT> --outdir <OUTDIR>
```

...
## 什么时候不要使用
- 患者直接沟通应使用 neoag-patient-report

## 必需输入
- `result_dir_or_summary`
...
```bash
neoag-skill run neoag-technical-report --outdir work/neoag-technical-report --dry-run
```

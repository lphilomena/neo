---
name: neoag-hla-loh-appm-review
description: Review HLA LOH, APPM, antigen-presentation integrity, and immune escape evidence.
---
...
```bash
python -m neoag_v03.agent_skills.appm_review --evidence-report reports/evidence_report.v041.html --outdir <OUTDIR>
```

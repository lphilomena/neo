...
| SHERPA / parameter-sherpa | Optional immunogenicity/modeling support; installs `parameter-sherpa` plus `GPy` | Optional | `bash .agents/skills/neoag-remote-deploy/scripts/13_install_readme_tools.sh --sherpa --allow-download --execute` | `SHERPA_PACKAGE` | `scripts/verify_all_tools_and_refs.sh` |

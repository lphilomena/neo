...
| Full default repository test suite | 439 passed, 105 skipped, 0 failed |
...
| Default central asset-source routing and explicit override | PASS (connection remains approval-gated) |

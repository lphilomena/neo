...
- `bin/neoag-v03 run-demo --sample-id V04DEMO --profile default --outdir work/release_demo_v04_basic` -> completed
- fixture `run-v03` with safety/immune escape inputs -> completed
